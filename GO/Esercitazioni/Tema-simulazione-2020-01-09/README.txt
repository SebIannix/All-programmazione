...
In testa a questi file si trova, sotto forma di commento, il testo dell'esercizio. Di seguito si trovano i test per fare una prima (auto)valutazione del proprio elaborato.



===== Uso dei test =====

Per svolgere il compito bisogna entrare in ogni sottodirectory e creare il relativo file 'go' (se ad esempio il test si chiama 'filtro_test.go' va creato il file 'filtro.go', attenzione a maiuscole e minuscole, in generale sono caratteri tutti minuscoli) secondo le specifiche.
