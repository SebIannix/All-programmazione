...
Scrivere un programma filtro.go che legge una sequenza di valori interi da linea di comando e controlla che si alternino valori pari e valori dispari.
...
func TestNoParm(t *testing.T) {
	subproc := exec.Command("./filtro") // presuppone compilato
...
func TestOneParm(t *testing.T) {
	subproc := exec.Command("./filtro", "2") // presuppone compilato
	out, err := subproc.CombinedOutput()
...
func TestWrong1(t *testing.T) {
	subproc := exec.Command("./filtro", "3", "8888", "0", "11", "57") // presuppone compilato
	out, err := subproc.CombinedOutput()
...
func TestWrong2(t *testing.T) {
	subproc := exec.Command("./filtro", "1", "2", "3", "5") // presuppone compilato
	out, err := subproc.CombinedOutput()
...
func TestWrong3(t *testing.T) {
	subproc := exec.Command("./filtro", "112", "1", "2", "3", "5") // presuppone compilato
	out, err := subproc.CombinedOutput()
...
func TestWrong4(t *testing.T) {
	subproc := exec.Command("./filtro", "5", "5", "10", "21", "40") // presuppone compilato
	out, err := subproc.CombinedOutput()
...
func TestOk1(t *testing.T) {
	subproc := exec.Command("./filtro", "4", "5", "12", "11", "0", "77") // presuppone compilato
	out, err := subproc.CombinedOutput()
...
func TestOk2(t *testing.T) {
	subproc := exec.Command("./filtro", "3", "4", "5", "12", "11", "0", "77") // presuppone compilato
	out, err := subproc.CombinedOutput()
...
func TestWrongType1(t *testing.T) {
	subproc := exec.Command("./filtro", "3", "4728", "5555y555", "-12", "-11", "0", "77") // presuppone compilato
	out, err := subproc.CombinedOutput()
...
func TestWrongType2(t *testing.T) {
	subproc := exec.Command("./filtro", "sadas3", "4728", "5555y555", "-12", "-11", "0", "77") // presuppone compilato
	out, err := subproc.CombinedOutput()
